...
class AnalysisPipelineHttpIntegrationTest {
    ...
    private Fixture fixture(boolean withGuide) throws IOException {
        ...
        savePrompt("PT-JOB-" + suffix, "JSON-01", "prompts/json-01-v1.0.txt");
        savePrompt("PT-CAND-" + suffix, "JSON-02", "prompts/json-02-v1.0.txt");
        savePrompt("PT-SYN-" + suffix, "JSON-05", "prompts/json-05-v1.0.txt");
