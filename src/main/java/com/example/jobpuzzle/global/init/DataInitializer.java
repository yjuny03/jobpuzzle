    ...
    public void run(ApplicationArguments args) {
        ...
        CandidateMaterialAnalysis candidateAnalysis =
                CandidateMaterialAnalysis.builder()
                        ...
                        .resumeAnalysis(candidateResult.getResume())
                        .coverLetterAnalysis(candidateResult.getCoverLetter())
                        .portfolioAnalysis(candidateResult.getPortfolio())
                        .experienceNoteAnalysis(candidateResult.getExperienceNote())
