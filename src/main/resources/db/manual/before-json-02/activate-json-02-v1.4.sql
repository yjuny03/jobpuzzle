-- 개발 DB 전용: JSON-02 v1.4 sourceRefs 배열 근거 정책을 활성화한다.
SELECT COUNT(*) AS target_version_count FROM prompt_template WHERE prompt_code = 'PT-CAND-001' AND version = 'v1.4';
START TRANSACTION;
...
'PT-CAND-001','지원자 자료 분석 프롬프트','v1.4','JSON-02','당신은 선택된 지원자 자료를 구조화하는 JSON-02 분석기다.
